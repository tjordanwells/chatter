...
function v() {
  const e = document.body,
    ...
    o = h(10) && getComputedStyle(t);
  return { height: x("Height", e, t, o), width: x("Width", e, t, o) };
}
var O =
  Object.assign ||
  function(e) {
...
function T(e, t, o = !1) {
  ...
  o &&
    "HTML" === t.nodeName &&
    ((d.top = n(d.top, 0)), (d.left = n(d.left, 0)));
  let u = L({
    top: p.top - d.top - m,
...
function G(e, t, o, n) {
  ...
  r.addEventListener(t, o, { passive: !0 }),
    i || G(a(r.parentNode), t, o, n),
    n.push(r);
}
function z(e, t, o, n) {
  (o.updateBound = n),
    q(e).addEventListener("resize", o.updateBound, { passive: !0 });
  const i = a(e);
  return (
    G(i, "scroll", o.updateBound, o.scrollParents),
    (o.scrollElement = i),
    (o.eventsEnabled = !0),
    o
  );
...
function te(e, t) {
  ...
  const { x: i, y: r } = t,
    { popper: p } = e.offsets,
    d = F(e.instance.modifiers, e => "applyStyle" === e.name).gpuAcceleration;
  void 0 !== d &&
    console.warn(
      "WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!"
    );
  const s = void 0 === d ? t.gpuAcceleration : d,
  ...
  let b, w;
  if (
    ((w = "bottom" == h ? -a.height + m.bottom : m.top),
    (b = "right" == u ? -a.width + m.right : m.left),
    s && g)
  )
    (l[g] = `translate3d(${b}px, ${w}px, 0)`),
      (l[h] = 0),
      (l[u] = 0),
    ...
    const e = "bottom" == h ? -1 : 1,
      t = "right" == u ? -1 : 1;
    (l[h] = w * e), (l[u] = b * t), (l.willChange = `${h}, ${u}`);
  }
  const y = { "x-placement": e.placement };
  return (
    (e.attributes = O({}, y, e.attributes)),
    (e.styles = O({}, l, e.styles)),
...
const pe = re.slice(3);
function de(e, t = !1) {
  const o = pe.indexOf(e),
    n = pe.slice(o + 1).concat(pe.slice(0, o));
...
var we = {
    ...
    keepTogether: { order: 400, enabled: !0, fn: ae },
    arrow: { order: 500, enabled: !0, fn: ne, element: "[x-arrow]" },
    flip: {
      order: 600,
      enabled: !0,
      fn: fe,
    ...
    hide: { order: 800, enabled: !0, fn: ge },
    computeStyle: {
      order: 850,
      enabled: !0,
      fn: te,
...
class Ee {
  constructor(e, t, o = {}) {
    (this.scheduleUpdate = () => requestAnimationFrame(this.update)),
      ...
      (this.options = O({}, Ee.Defaults, o)),
      (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
      (this.reference = e && e.jquery ? e[0] : e),
      (this.popper = t && t.jquery ? t[0] : t),
      (this.options.modifiers = {}),
      Object.keys(O({}, Ee.Defaults.modifiers, o.modifiers)).forEach(e => {
...
(Ee.Utils = ("undefined" == typeof window ? global : window).PopperUtils),
  (Ee.placements = re),
  (Ee.Defaults = ye);
export default Ee;
